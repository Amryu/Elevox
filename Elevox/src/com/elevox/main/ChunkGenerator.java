...
public abstract class ChunkGenerator {
     ...
     */
    public Block[][][] generate(World world, int x, int z) {
     ...
     */
    public short[][] generateExtBlockSections(World world, int x, int z, BiomeGrid biomes) {
     ...
     * @return short[][] containing the types for each block created by this generator
     */
    public byte[][] generateBlockSections(World world, int x, int z, BiomeGrid biomes) {
...
//        Block highest = world.getHighestBlockYAt(x, z);
