...
public class Location implements Cloneable {
    ...
    public Chunk getChunk() {
        return world.chunkMap.getChunkAt((int) Math.floor(this.x), (int) Math.floor(this.z));
    }
    ...
    public Block getBlock() {
        return world.chunkMap.getBlockAt((int) Math.floor(this.x), (int) Math.floor(this.y), (int) Math.floor(this.z));
    }
